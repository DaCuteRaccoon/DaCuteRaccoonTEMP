...
Add followers, YouTube, Discord, etc.
<br/>

# Add JavaScript code for about me, example for someone else here:
```js
...
const DaCuteRaccoon = {
  ...
  code: ["JavaScript", "HTML", "CSS", "Batch", "Shell", "Python"],
  tools: ["Node.js", "Firebase", "Vercel"],
  current_job: {
    role: "CEO",
    team: "N/A",
    company: "Raccoon, Inc.",
